<?php
$options = array();
$options['title'] = 'User Gallery'; // what you call your content
$options['description'] = 'Allow people to upload files to a paged gallery'; // a brief description of what your content does, any restrictions, etc
