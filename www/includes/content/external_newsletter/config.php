<?php
$options = array();
$options['title'] = 'Newsletter Signup Portal'; // what you call your content
$options['description'] = 'Easily integrate users singning up for 3rd party newsletters'; // a brief description of what your content does, any restrictions, etc
