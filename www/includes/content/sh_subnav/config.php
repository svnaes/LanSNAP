<?php
$options = array();
$options['title'] = 'Navigation'; // what you call your content
$options['description'] = 'Relies on Site Heirarchy to drive a navigation or subnavigation'; // a brief description of what your content does, any restrictions, etc
...
if (USER_ACCESS < 5)
{
	$options['on_edit_load'] = 'Pico_SiteHeirarchy();';
}
/*
