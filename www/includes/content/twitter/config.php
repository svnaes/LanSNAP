<?php
$options = array();
$options['title'] = 'Twitter'; // what you call your content
$options['description'] = 'Simple twitter feed'; // a brief description of what your content does, any restrictions, etc
...
$options['admin_css'] = ''; // same as static, but if logged in as moderator or higher
