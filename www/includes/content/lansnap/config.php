<?php
$options = array();
$options['title'] = 'LANsnap'; // what you call your content
$options['description'] = 'LANsnap configuration tool'; // a brief description of what your content does, any restrictions, etc
...
$options['edit_options'] = array(
	array(
		'container'=>'co_tickets',
		'link_text'=>'Tickets',
		'inc_file'=>'tickets.php',
		'access'=>4
	),
