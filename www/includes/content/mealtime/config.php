<?php
$options = array();
$options['title'] = 'Meal Time'; // what you call your content
$options['description'] = 'See what people want to eat at the LAN!'; // a brief description of what your content does, any restrictions, etc
