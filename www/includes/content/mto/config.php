<?php
$options = array();
$options['title'] = 'MTO Order'; // what you call your content
$options['description'] = 'People ordering food!'; // a brief description of what your content does, any restrictions, etc
