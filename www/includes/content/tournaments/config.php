<?php
$options = array();
$options['title'] = 'Tournaments'; // what you call your content
$options['description'] = 'LAN Tournament System'; // a brief description of what your content does, any restrictions, etc
