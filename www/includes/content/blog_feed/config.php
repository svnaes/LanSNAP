<?php
$options = array();
$options['title'] = 'Blog Feed'; // what you call your content
$options['description'] = 'Blog feed to popluate other sections of the site<br />!!! The view setting on this should always be "Always Same" and a blog must exist already for this to work !!!'; // a brief description of what your content does, any restrictions, etc
